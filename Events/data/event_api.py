# Это API когда нибудь я ее починю
# from flask import jsonify, Blueprint, request
#
# blueprint = Blueprint("event_api", __name__, template_folder="templates")
#
#
...
#     elif not all(
#         key in request.json
#         for key in ["id", "photo_name", "name", "signature", "link", "created_date"]
#     ):
#         return jsonify({"error": "Bad request"})
#
#     db_sess = db_session_event.create_session()
...
#
#     event_to_update = (
#         db_sess.query(All_events).filter(All_events.id == update_id).first()
#     )
